...
@Component
@Aspect
public class KayleServerAspect {

    @Pointcut("execution(* com.kayle.server.app.impl.*Impl.*(..))")
    public void appPointcut(){}

    @Pointcut("execution(* com.kayle.server.common.*Impl.*(..))")
